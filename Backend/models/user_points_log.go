...
type UserPointsLog struct {
	...
	ReasonCode     string         `gorm:"type:varchar(50);not null;index:idx_user_points_source_reason,priority:2" json:"reason_code"` // E.g., "T1", "N1"
	...
	SourceEntityID *uuid.UUID     `gorm:"type:uuid;index;index:idx_user_points_source_reason,priority:1" json:"source_entity_id"`      // Optional link to Workout/Meal/etc
